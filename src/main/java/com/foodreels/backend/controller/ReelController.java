...
public class ReelController {
    ...
    public ResponseEntity<ReelResponseDTO> createReel(
        ...
        ReelResponseDTO createdReel =
                reelService.createReel(requestDTO);
    ...
    public ResponseEntity<List<ReelResponseDTO>> getReelsByFood(
        ...
        List<ReelResponseDTO> reels =
                reelService.getReelsByFoodId(foodId);
    ...
    public ResponseEntity<ReelResponseDTO> updateReel(
        ...
        ReelResponseDTO updatedReel =
                reelService.updateReel(id, requestDTO);
